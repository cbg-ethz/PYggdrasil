...
#| warning: false
#| label: tree-sim-iter
#| fig-cap: "The evolution of the tree similarity over the MCMC iterations."
...
#| warning: false
#| label: rhat-iter
#| fig-cap: "The evolution of the Gelman-Rubin statistic over the MCMC iterations."
# two subplots one for the AD and one for the DL
fig, axs = plt.subplots(1, 2, figsize=(10, 5))
for i in range(len(mcmc_datas)):
...
#| warning: false
#| label: tree-vis
#| fig-cap: "The trees sampled by the MCMC chains as histograms."
# two subplots one for the AD and one for the DL
